...
export const orderCreateReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case ORDER_CREATE_FAIL:
      return { loadingCreateOrder: false, error: action.payload };
...
//       };
//     case ORDER_CREATE_FAIL:
//       return { loadingCreateOrder: false, errorCreateOrder: action.payload };
//     //Order details
//     case ORDER_DETAILS_REQUEST:
...
//         ...state,
//         loadingDetailsOrder: false,
//         errorDetailsOrder: action.payload,
//       };
//     //Order Pay
//     case ORDER_PAY_REQUEST:
